...
| LM Studio LAN endpoint | Unverified | Medium | Advertised <MAC_LAN_IP> address timed out |
...
- the advertised address <MAC_LAN_IP>:1234 timed out during the direct check;
